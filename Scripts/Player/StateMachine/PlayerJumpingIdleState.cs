...
[CreateAssetMenu(
    fileName = "PlayerJumpingIdleState",
    menuName = "Flash/Player/Jumping States/Idle"
)]
public sealed class PlayerJumpingIdleState : PlayerJumpingState
{
    ...
    {
        context.Player.SetJumpInputEnabled(true);
        _playerJump.ApplyGravity(true);
        _animation.ApplyJumpingState(true, false);
    }
}
// PlayerJumpingIdleState은 플레이어 상태의 진입·종료 조건과 해당 상태에서의 입력 및 표현 규칙을 정의한다.
