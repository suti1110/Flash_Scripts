...
[CreateAssetMenu(
    fileName = "PlayerJumpingFallingState",
    menuName = "Flash/Player/Jumping States/Falling"
)]
public sealed class PlayerJumpingFallingState : PlayerJumpingState
{
    ...
    internal override void Enter(PlayerJumpingStateContext context)
    {
        ...
        _animation.ApplyJumpingState(false, false);
    }
}
// PlayerJumpingFallingState은 플레이어 상태의 진입·종료 조건과 해당 상태에서의 입력 및 표현 규칙을 정의한다.
